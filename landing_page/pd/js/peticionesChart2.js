...
let valueCurrent_fundingamountI = document.getElementById("current_fundingamountI").value;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    newPercent = parseInt(sessionStorage.getItem('Value_current_withdrawal_selected$')) * 10 / 100;
    ...
    document.getElementById('withsavvlyMonthly').innerHTML = sessionStorage.getItem("prueba");
    ...
    if (sessionStorage.getItem("Value_current_age_selected2$") != null) {
        $('#current_ageI').val(sessionStorage.getItem('Value_current_age_selected2$'));
        valueCurrent_ageI = sessionStorage.getItem('Value_current_age_selected2$');
        document.getElementById('demoAge').innerHTML = sessionStorage.getItem("Value_current_age_selected2$");
        ...
        document.getElementById('demoAge').innerHTML = valueCurrent_ageI;
        $('#current_ageI').val(valueCurrent_ageI);
    }
    ...
    document.getElementById('savvlyAgeToReceive').innerHTML = valueCurrent_payoutI;

    cargar();

    document.getElementById('withsavvlyRetire').innerHTML = parseInt(withRounded).toLocaleString('en-US');
    document.getElementById('savvlyValueToReceive').innerHTML = parseInt(withRounded).toLocaleString('en-US');
...
current_ageI.oninput = function() {
    valueCurrent_ageI = current_ageI.value;
    document.getElementById('demoAge').innerHTML = valueCurrent_ageI;
    sessionStorage.setItem("Value_current_age_selected2$", valueCurrent_ageI);
...
current_fundingamountI.oninput = function() {
    ...
    newPercent = parseInt(sessionStorage.getItem('Value_current_withdrawal_selected$')) * valueCurrent_fundingamountI / 100;
