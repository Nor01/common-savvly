...
class Dbhandles:
    ...
    # Delete FILES tables
    # -----------------------------------
    def delete_file_tables(self):
        self.get_filetables().delete_tables()
        self.set_filetables(None)
    ...
    # -----------------------------------
    # Get the FileTables object
    # -----------------------------------
    def get_filetables(self) -> DbFiles:
        if self.filetables is None:
            self.filetables = DbFiles()
        return self.filetables

    # -----------------------------------
    # Set the FileTables object
    # -----------------------------------
    def set_filetables(self, filetables: DbFiles):
