...
#demo_docs_path = path.abspath(path.join(path.dirname(path.realpath(__file__)), "../../static/savvly_documents"))
#if "DOCS_BASE_DIR" in environ:
#    demo_docs_path = environ.get("DOCS_BASE_DIR")
