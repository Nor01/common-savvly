...
# ---------------------------------------------------------------
def fileop_upload_files(files_ids : list) -> list:
    image_num = 1
    fname_list=[]
...
# -------------------------------------------------------
def fileop_delete_files(file_ext):
    folder = utils_get_upload_folder()
...
# Download a file
# -------------------------------------------------------
def fileop_download_file(file_name):
...
# Upload User Photo
# -------------------------------------------------------
def fileop_upload_user_image(puserobj, userid : str, file_list : list) -> str:
    if puserobj is None:
